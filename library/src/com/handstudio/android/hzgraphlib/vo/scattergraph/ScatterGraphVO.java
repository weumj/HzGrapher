...
public class ScatterGraphVO extends TwoDimensionGraph {
	...
	public ScatterGraphVO(String[] legendArr, List<ScatterGraph> arrGraph,
			...
			int paddingRight, int marginTop, int marginRight, int maxValueX,
			int maxValueY, int incrementX, int incrementY) {
	...
	public ScatterGraphVO(String[] legendArr, List<ScatterGraph> arrGraph,
			int graphBG, int paddingTop, int paddingBottom, int paddingLeft,
			int paddingRight, int marginTop, int marginRight, int maxValueX,
			int maxValueY, int incrementX, int incrementY) {
		super(paddingBottom, paddingTop, paddingLeft, paddingRight, marginTop,
				marginRight);
